        ...
        <div className="p-6 border-b border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <span className="inline-block px-2 py-1 text-xs rounded-full text-white bg-blue-500">
                {user.role}
              </span>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-7xl mx-auto">
            {/* Welcome Card */}
            <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg shadow-lg p-6 mb-6">
              <h2 className="text-2xl font-bold text-white mb-2">
                Welcome to Coral Gardens
              </h2>
              <p className="text-blue-100">
                Restaurant Management System - {user.role} Dashboard
              </p>
            </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-sm text-gray-600">Order #1230 completed</p>
